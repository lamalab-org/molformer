...
def get_parser(parser=None):
    ...
    parser.add_argument('--seed_path',
                           type=str, default="../../../../../molformer/data/Pretrained MoLFormer/checkpoints/N-Step-Checkpoint_3_30000.ckpt ",
    ...
    parser.add_argument("--dims", type=int, nargs="*", default="768 768 768 1", required=False)
    # parser.add_argument(
    #     "--smiles_embedding",
    #     type=str,
